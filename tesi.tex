...
%	\end{symbols}
	...
	\begin{thebibliography}{9}
		...
		\href{https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki}{\texttt{https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki}}
		
		\bibitem{2} 
		BIP39, Bitcoin Improvement Proposal number 39 \\
		\href{https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki}{\texttt{https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki}}
		
		
		\bibitem{3} 
		Electrum Bitcoin Wallet \\
		\href{https://electrum.org}{\texttt{https://electrum.org}}
		
		\bibitem{4} 
		BIP43, Bitcoin Improvement Proposal number 43 \\
		\href{https://github.com/bitcoin/bips/blob/master/bip-0043.mediawiki}{\texttt{https://github.com/bitcoin/bips/blob/master/bip-0043.mediawiki}}

		\bibitem{5} 
		BIP44, Bitcoin Improvement Proposal number 44 \\
		\href{https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki}{\texttt{https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki}}
		
		\bibitem{6} 
		BIP49, Bitcoin Improvement Proposal number 49 \\
		\href{https://github.com/bitcoin/bips/blob/master/bip-0049.mediawiki}{\texttt{https://github.com/bitcoin/bips/blob/master/bip-0049.mediawiki}}
