...
\section{BIP 43}
This BIP introduces a "Purpose Field" for use in Hierarchical deterministic wallets. The first child of the extended master private key specify the purpose of the entire branch.
\begin{equation*}
m\; \;/\;\; purpose'\;\; /\;\; *
\end{equation*}
...
\end{equation*}
This scheme follow the logic of BIP44 and let the user the possibility to have a multi-coin wallet just by choosing a specific \textit{coin\_type}.
\\ \\
\begin{remark}
